...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — <?php echo e(config('daya.engine_name', 'DAYA AI')); ?></title>
...
<div class="wrap">
    <aside class="side" id="side">
        <div class="brand"><span class="dot">⚡</span><?php echo e(config('daya.engine_name', 'DAYA AI')); ?></div>

        <a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e($r==='admin.dashboard'?'active':''); ?>"><?php echo $svg('home'); ?> Dashboard</a>

        <div class="sep">Mulai</div>
        <a href="<?php echo e(route('admin.quickstart.index')); ?>" class="<?php echo e($aktif('admin.quickstart')); ?>"><?php echo $svg('rocket'); ?> Mulai Cepat</a>
        <a href="<?php echo e(route('admin.assistant.index')); ?>" class="<?php echo e($aktif('admin.assistant')); ?>"><?php echo $svg('brain'); ?> Asisten SEO</a>

        <div class="sep">Konten</div>
        <a href="<?php echo e(route('admin.content.index')); ?>" class="<?php echo e($aktif('admin.content')); ?>"><?php echo $svg('layers'); ?> Variasi Konten</a>
        <a href="<?php echo e(route('admin.faqs.index')); ?>" class="<?php echo e($aktif('admin.faqs')); ?>"><?php echo $svg('chat'); ?> FAQ</a>
        <a href="<?php echo e(route('admin.templates.index')); ?>" class="<?php echo e($aktif('admin.templates')); ?>"><?php echo $svg('grid'); ?> Template</a>
        <a href="<?php echo e(route('admin.keywords.index')); ?>" class="<?php echo e($aktif('admin.keywords')); ?>"><?php echo $svg('tag'); ?> Keyword AI</a>

        <div class="sep">Halaman</div>
        <a href="<?php echo e(route('admin.imports.index')); ?>" class="<?php echo e($aktif('admin.imports')); ?>"><?php echo $svg('upload'); ?> Import Data</a>
        <a href="<?php echo e(route('admin.pages.index')); ?>" class="<?php echo e($aktif('admin.pages')); ?>"><?php echo $svg('file'); ?> Halaman pSEO</a>
        <a href="<?php echo e(route('admin.sitepages.index')); ?>" class="<?php echo e($aktif('admin.sitepages')); ?>"><?php echo $svg('map'); ?> Halaman Statis</a>

        <div class="sep">Performa</div>
        <a href="<?php echo e(route('admin.leads.index')); ?>" class="<?php echo e($aktif('admin.leads')); ?>"><?php echo $svg('wa'); ?> Lead WhatsApp</a>
        <a href="<?php echo e(route('admin.indexing.index')); ?>" class="<?php echo e($aktif('admin.indexing')); ?>"><?php echo $svg('search'); ?> Indexing &amp; Peringkat</a>

        <div class="sep">Sistem</div>
        <a href="<?php echo e(route('admin.settings.edit')); ?>" class="<?php echo e($aktif('admin.settings')); ?>"><?php echo $svg('gear'); ?> Pengaturan</a>
        <a href="<?php echo e(url('/sitemap.xml')); ?>" target="_blank" rel="noopener"><?php echo $svg('map'); ?> Sitemap <span class="ext">&#8599;</span></a>
    </aside>
    ...
    <div class="main">
        <div class="topbar">
            <div style="display:flex;align-items:center">
                ...
                <div>
                    ...
                    <div class="sub"><?php echo e(\App\Models\Setting::get('brand_name') ?: 'Nama brand belum diisi'); ?></div>
                </div>
            </div>
        ...
        <div class="content">
            ...
            <?php if($errors->any()): ?>
                <div class="errs"><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div><?php echo e($e); ?></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
            <?php endif; ?>
...
(() => {
    ...
    <?php if(session('status')): ?>
        showToast({type:'success', message:<?php echo json_encode(session('status'), 15, 512) ?>, duration:4200});
    <?php endif; ?>
    <?php if($errors->any()): ?>
        showToast({type:'error', message:<?php echo json_encode($errors->first(), 15, 512) ?>, duration:6000});
    <?php endif; ?>
})();
</script>
</body>
</html>
<?php /**PATH D:\Project\CEGU.CO.ID\DAYA AI ENGINE\daya-ai-engine\seo-main\resources\views/admin/layout.blade.php ENDPATH**/ ?>