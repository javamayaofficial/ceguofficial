...
<head>
    ...
    <title>Login — <?php echo e(config('daya.engine_name', 'DAYA AI')); ?></title>
    <style>
...
<body>
    <form class="box" method="POST" action="<?php echo e(route('login')); ?>">
        <?php echo csrf_field(); ?>
        <h1><?php echo e(config('daya.engine_name', 'DAYA AI')); ?></h1>
...
<?php /**PATH D:\Project\CEGU.CO.ID\DAYA AI ENGINE\daya-ai-engine\seo-main\resources\views/auth/login.blade.php ENDPATH**/ ?>